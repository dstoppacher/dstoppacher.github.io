...
<div class="two-images">
  ...
  <figure class="two-images-item">
    <img src="{{ site.baseurl }}/pictures/IC_5332_-_HST.jpg" alt="IC 5332 imaged by the Hubble Space Telescope (by Judy Schmidt)">
    <figcaption>IC 5332 imaged by the Hubble Space Telescope (by Judy Schmidt).</figcaption>
  </figure>
...
<div class="imgae1-image2">
    ...
    <img src="{{ site.baseurl }}/pictures/IC_5332_-_HST.jpg" width="40%" style="border-radius: 5px" alt="IC 5332 imaged by the Hubble Space Telescope (by Judy Schmidt)">
	</div>
	<div class="image1-image2-img2">
	<img src="{{ site.baseurl }}/pictures/Messier_87_Hubble_WikiSky.jpg" width="40%" style="border-radius: 5px" alt="The galactic core of Messier 87 as imaged by the Hubble Space Telescope"></div>
</div>
