...
<div class="text-block" style="font-size: 0.9em">
	...
	<img src="{{ site.baseurl }}/pictures/School_talk.jpg" width="75%" style="border-radius: 5px; align:center" alt="Doris Stoppacher"/>
</div>
...
<div class="text-image" style="margin-bottom: 4em">
	...
	<div class="text-image-img">
    	<img src="{{ site.baseurl }}/pictures/CAHA_1.23m_small.jpg" width="100%" alt="CAHA telescope 1.23m (Almería, Spain)">
	</div>
</div>
